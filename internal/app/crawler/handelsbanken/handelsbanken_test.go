...
func TestHandelsbankenCrawler_Crawl(t *testing.T) {
	...
	listRatesJSON := crawlertest.LoadGoldenFile(t, "testdata/handelsbanken_list_rates.json")
	avgRatesJSON := crawlertest.LoadGoldenFile(t, "testdata/handelsbanken_avg_rates.json")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, handelsbankenBankName)
		})
	}
}
...
func TestHandelsbankenCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &HandelsbankenCrawler{}
}
