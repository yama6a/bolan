...
func createSEBMockFetch(t *testing.T) func(url string, headers map[string]string) (string, error) {
	...
	pageHTML := crawlertest.LoadGoldenFile(t, "testdata/seb_page.html")
	mainJS := crawlertest.LoadGoldenFile(t, "testdata/seb_main.js")
	listRatesJSON := crawlertest.LoadGoldenFile(t, "testdata/seb_list_rates.json")
	avgRatesJSON := crawlertest.LoadGoldenFile(t, "testdata/seb_avg_rates.json")
...
func TestSebBankCrawler_Crawl(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, sebBankName)
		})
	}
}
...
func TestSebBankCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &SebBankCrawler{}
}
