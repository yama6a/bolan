...
func TestDanskeBankCrawler_Crawl(t *testing.T) {
	...
	goldenHTML := crawlertest.LoadGoldenFile(t, "testdata/danske_bank.html")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, danskeBankName)
		})
	}
}
...
func TestDanskeBankCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &DanskeBankCrawler{}
}
