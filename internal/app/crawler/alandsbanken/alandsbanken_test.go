...
func TestAlandsbankCrawler_Crawl(t *testing.T) {
	...
	html := crawlertest.LoadGoldenFile(t, "testdata/alandsbanken.html")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, alandsbankBankName)
		})
	}
}
...
func TestAlandsbankCrawler_extractListRates(t *testing.T) {
	...
	goldenHTML := crawlertest.LoadGoldenFile(t, "testdata/alandsbanken.html")
	logger := zap.NewNop()
...
func TestAlandsbankCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &AlandsbankCrawler{}
}
