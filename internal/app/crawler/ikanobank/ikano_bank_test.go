...
func TestIkanoBankCrawler_Crawl(t *testing.T) {
	...
	listRatesJSON := crawlertest.LoadGoldenFile(t, "testdata/ikano_bank_list_rates.json")
	avgRatesHTML := crawlertest.LoadGoldenFile(t, "testdata/ikano_bank_avg_rates.html")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, ikanoBankName)
		})
	}
}
...
func TestIkanoBankCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &IkanoBankCrawler{}
}
