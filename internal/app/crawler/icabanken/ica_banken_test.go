...
func TestICABankenCrawler_Crawl(t *testing.T) {
	...
	goldenHTML := crawlertest.LoadGoldenFile(t, "testdata/ica_banken.html")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, icaBankenName)
		})
	}
}
...
func TestICABankenCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &ICABankenCrawler{}
}
