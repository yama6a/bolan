...
Skandiabanken embeds rate data as JSON within JavaScript code in their HTML pages. The data is stored in a
`SKB.pageContent` variable that can be extracted using regex.
