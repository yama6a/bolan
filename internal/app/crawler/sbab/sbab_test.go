...
func TestSBABCrawler_Crawl(t *testing.T) {
	...
	listRatesJSON := crawlertest.LoadGoldenFile(t, "testdata/sbab_list_rates.json")
	avgRatesJSON := crawlertest.LoadGoldenFile(t, "testdata/sbab_avg_rates.json")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, sbabBankName)
		})
	}
}
...
func TestSBABCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &SBABCrawler{}
}
