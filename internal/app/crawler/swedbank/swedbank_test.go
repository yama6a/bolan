...
func TestSwedbankCrawler_Crawl(t *testing.T) {
	...
	listRatesHTML := crawlertest.LoadGoldenFile(t, "testdata/swedbank.html")
	historicRatesHTML := crawlertest.LoadGoldenFile(t, "testdata/swedbank_historic.html")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			crawlertest.AssertBankName(t, results, swedbankBankName)
		})
	}
}
...
func TestSwedbankCrawler_extractListRates(t *testing.T) {
	...
	goldenHTML := crawlertest.LoadGoldenFile(t, "testdata/swedbank.html")
	logger := zap.NewNop()
...
func TestSwedbankCrawler_extractHistoricAverageRates(t *testing.T) {
	...
	historicHTML := crawlertest.LoadGoldenFile(t, "testdata/swedbank_historic.html")
	logger := zap.NewNop()
	crawler := &SwedbankCrawler{logger: logger}
	crawlTime := time.Date(2025, 12, 1, 10, 0, 0, 0, time.UTC)
...
func TestSwedbankCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ crawlertest.SiteCrawler = &SwedbankCrawler{}
}
