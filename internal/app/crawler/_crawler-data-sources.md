...
| Ikano Bank    | 1 JSON API + 1 HTML page | List + Average | No                      | User-Agent             |
| Ålandsbanken  | 1 HTML page  | List + Average | No                      | User-Agent             |
...
| Ikano Bank    | `ikano_bank_list_rates.json`, `ikano_bank_avg_rates.html`                   |
...
```bash
curl -s 'https://ikanobank.se/api/interesttable/gettabledata' \
  -H 'User-Agent: Mozilla/5.0' > internal/app/crawler/testdata/ikano_bank_list_rates.json

curl -s 'https://ikanobank.se/bolan/bolanerantor' \
  -H 'User-Agent: Mozilla/5.0' > internal/app/crawler/testdata/ikano_bank_avg_rates.html
```
...
| Bluestep      | `bluestep_list_rates.html`, `bluestep_avg_rates.html`                       |
| Ikano Bank    | `ikano_bank_list_rates.json`, `ikano_bank_avg_rates.html`                   |
| Ålandsbanken  | `alandsbanken.html`                                                         |

### Refreshing Golden Files (continued)

**Ålandsbanken:**

```bash
curl -s 'https://www.alandsbanken.se/banktjanster/lana-pengar/bolan' \
  -H 'User-Agent: Mozilla/5.0' > internal/app/crawler/testdata/alandsbanken.html
```
