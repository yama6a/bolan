...
func TestSkandiaCrawler_Crawl(t *testing.T) {
	...
	listRatesHTML := loadGoldenFile(t, "testdata/skandia_list_rates.html")
	avgRatesHTML := loadGoldenFile(t, "testdata/skandia_avg_rates.html")
	logger := zap.NewNop()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assertBankName(t, results, skandiaBankName)
		})
	}
}
...
func TestSkandiaCrawler_InterfaceCompliance(t *testing.T) {
	...
	var _ SiteCrawler = &SkandiaCrawler{}
}
